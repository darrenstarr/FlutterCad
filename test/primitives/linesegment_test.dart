...
void main() {
  test('Constructor and properties', () {
    LineSegment testSegmentA = new LineSegment.zero();
    ...
    LineSegment testSegmentB = new LineSegment(
        Point.tryParse("(5mm,6mm)")!, Point.tryParse("(8mm,9mm)")!);
  ...
  test('Set segment length', () {
    LineSegment testSegmentA = LineSegment.tryParse("[(4mm,0mm)-(0mm,3mm)]")!;
  ...
  test('Ortaganol bisecting segment', () {
    ...
    var cwLength = new Measurement(10, MeasurementUnit.millimeters);
    var ccwLength = new Measurement(20, MeasurementUnit.millimeters);
  ...
  test('Extend line by distance', () {
    var testSegmentA = LineSegment.tryParse("[(40mm,0mm)-(0mm,30mm)]")!;
    var result = testSegmentA
        .extendedBy(new Measurement(50, MeasurementUnit.millimeters));
  ...
  test('Copy line with new distance', () {
    var testSegmentA = LineSegment.tryParse("[(40mm,0mm)-(0mm,30mm)]")!;
    var result = testSegmentA
        .withLength(new Measurement(100, MeasurementUnit.millimeters));
